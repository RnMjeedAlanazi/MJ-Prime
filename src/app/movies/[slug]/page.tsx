  ...
  if (!movie) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingTop: 80, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 900, fontFamily: 'Almarai, sans-serif', marginBottom: 16 }}>الفيلم غير موجود</h1>
        <p style={{ color: 'var(--text-secondary)', marginBottom: 30, fontFamily: 'Almarai, sans-serif', fontSize: 16 }}>عذراً، لم يتم العثور على هذا الفيلم أو أنه غير متوفر حالياً.</p>
        <Link href="/movies">
